...
- [LILYGO T-CAN485](https://lilygo.cc/products/t-can485) configured with [esphome-nibe](https://github.com/elupus/esphome-nibe) connected to the heat pump over RS-485/MODBUS for more monitoring/control from the [Nibe Heat Pump integration](https://www.home-assistant.io/integrations/nibe_heatpump/) in Home Assistant.
